 ...
 * @returns {Temporal.ZonedDateTime}
 */
function getShiftEndByElapsedDuration(start, durationLike) {
 ...
 * @returns {Temporal.ZonedDateTime}
 */
function getShiftEndByWallClockDuration(start, durationLike) {
  const zonedStart = toZonedDateTime(start);
  const duration = toDuration(durationLike);
 ...
 * }}
 */
function compareShiftEndings(start, durationLike) {
